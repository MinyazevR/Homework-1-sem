...
bool testWritingDigitsToArray()
{
    ...
    writeDigitsToArray(arrayForWritingTheNumberMinus12, -12);
    ...
    writeDigitsToArray(arrayForWritingTheNumberMinus245, -245);
